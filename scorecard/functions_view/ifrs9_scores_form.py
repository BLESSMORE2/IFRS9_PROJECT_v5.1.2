...
def ifrs9_scores_edit_view(request: HttpRequest, evaluation_id: int) -> HttpResponse:
    ...
    context = {
        ...
        "autofill_missing_labels": saved_autofill_metadata.get(
            "current_missing_required_labels",
            saved_autofill_metadata.get("missing_required_labels", []),
        ),
        "autofill_applied_attribute_ids": saved_autofill_metadata.get("applied_attribute_ids", []),
        "autofill_missing_attribute_ids": saved_autofill_metadata.get(
            "current_missing_required_ids",
            saved_autofill_metadata.get("missing_required_attribute_ids", []),
        ),
        "autofill_profile_changes": autofill_profile_changes,
    }
