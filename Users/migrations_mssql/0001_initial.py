...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_view_settings_user_roles', 'Can view settings user roles'), ('can_assign_settings_roles', 'Can assign settings user roles'), ('can_view_settings_database', 'Can view settings database configuration'), ('can_manage_settings_database', 'Can manage settings database configuration')],
            },
        ),
        migrations.CreateModel(
            name='AuditTrail',
